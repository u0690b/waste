...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Place::create(['id' => 1, 'name' => "Аймаг/нийслэлийн байгаль орчны газар"]);
        Place::create(['id' => 2, 'name' => "ЗДТГ-ын хяналт шалгалтын газар"]);
        Place::create(['id' => 3, 'name' => "Хүнс хөдөө аж ахуйн газар"]);
        Place::create(['id' => 4, 'name' => "Аймаг/нийслэлийн эрүүл мэндийн газар"]);
        Place::create(['id' => 5, 'name' => "Экологийн цагдаагийн алба"]);
        Place::create(['id' => 6, 'name' => "Нийслэлийн агаар орчны бохирдолтой тэмцэх газар"]);
        Place::create(['id' => 7, 'name' => "Автотээврийн үндэсний төв, замын цагдаагийн газар"]);
        Place::create(['id' => 8, 'name' => "Байгаль орчны байцаагч"]);
        Place::create(['id' => 9, 'name' => "Харьяа хамгаалалтын захиргааны байцаагч"]);

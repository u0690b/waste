...
<template>
        ...
        <div className="grid gap-6  grid-cols-2 lg:grid-cols-4">
            <div class="hover:shadow-xl border-4 border-solid  rounded-2xl border-[#406f47]">
                <div class="flex flex-row items-center justify-between pb-2 space-y-0 card-header">
                    <h3 class="text-sm font-medium">Нийт зөрчил</h3>
                    <DocumentIcon class="w-6 h-6 text-muted-foreground" />
                </div>
                <div class="card-body">
                    <div class="text-3xl font-bold">{{ totalReportStat.toString().replace(/\D/g, "") }}</div>
                    <p class="text-xs text-muted-foreground">Өнгөрсөн сараас {{
                        totalReportPrevMonthStat.percentage_change }}%</p>
                </div>
            </div>
            <div class="hover:shadow-xl border-4 border-solid  rounded-2xl border-[#406f47]">
                <div class="flex flex-row items-center justify-between pb-2 space-y-0 card-header">
                ...
                <div class="card-body">
                    ...
                    <p class="text-xs text-muted-foreground">Энэ сар +{{ totalClearPrevMonthStat }} шийдвэрлэсэн
                    </p>
                </div>
            </div>
            <div class="hover:shadow-xl border-4 border-solid  rounded-2xl border-[#406f47]">
                ...
                <div class="card-body">
                    <div><span class="text-3xl font-bold">{{ totalUsers }}</span> </div>
            ...
            <div class="hover:shadow-lg flex flex-col justify-center card bg-[#dde9aa] ">
                <div class="pt-6 card-body">
                    ...
                    <p class="mb-4 text-xs sm:text-sm ">Байгалиа хайрлаж, бохирдлыг багасгах нь хүн бүрийн
                        үүрэг.</p>
                    <a type="button" href="/mobile" target="_blank" variant="secondary"
                        class="w-full text-xs btn btn-success sm:text-sm">
                        Мобайл хувилбар
    ...
    <div class="border-4 border-solid  rounded-2xl border-[#406f47]">
        <div class="grid gap-4 lg:grid-cols-2">
            <div class="flex items-center max-sm:text-xs">
                <div class="p-4 px-4  md:p-8 text-[#406f47]  sm:px-8 text-center" id="about" role="tabpanel"
                    aria-labelledby="about-tab">
                    <h2 class="mb-5 font-extrabold tracking-tight ms:text-2xl md:text-4xl slide-in-bottom">
                        БОХИРДОЛ БАГАСАХАД БҮГДИЙН ОРОЛЦОО ЧУХАЛ , ОРЧНОО ЦЭВЭРЛЭ, ИРЭЭДҮЙГЭЭ ГЭРЭЛТҮҮЛ, ЦЭВЭР
                        ОРЧИН — ЦЭГЦЭРСЭН АМЬДРАЛ
                    </h2>
    ...
    <section>
        ...
        <div class="grid gap-8 py-4 text-center md:grid-cols-3 max-sm:text-xs">
            ...
            <div class="p-4 border-[#406f47] border-4 hover:shadow-lg inset-2 shadow-[#31A95D22]  rounded-lg ">
                ...
                <div class="card-body">
                    Илгээсэн зураг, байршил нь зөрчлийн мэдээллийн санд бүртгэгдэнэ. Харьяа байгаль орчны
                    хяналтын байцаагч мэдэгдэл хүлээн авна.
                </div>
            </div>
            <div class="p-4 border-[#406f47] border-4 hover:shadow-lg inset-2 shadow-[#31A95D22]  rounded-lg">
    ...
    <section>
        <div
            className="flex flex-col gap-6 animate-in fade-in-0 duration-500 border-[#406f47] border-4  hover:shadow-lg inset-2 shadow-[#31A95D22]  rounded-lg">

            <div class="grid gap-6 ">
                <div class="col-span-2 px-4 py-2 overflow-hidden border rounded-md shadow">
                    <h3 class="flex mb-4 text-xl text-gray-600"><svg xmlns="http://www.w3.org/2000/svg" fill="none"
                    ...
                    <VueApexCharts class="p-4 mb-8" type="bar" height="350" :options="regionOptions.chartOptions"
                        :series="regionOptions.series">
                    </VueApexCharts>

                    <p class="mt-12">Аймаг нийслэлээр</p>

                    <VueApexCharts class="p-4 mb-8" type="bar" height="350" :options="regionOptions1.chartOptions"
                        :series="regionOptions1.series">
                    </VueApexCharts>
                </div>

    ...
    <div class="bg-white rounded shadow overflow-hidden max-w-3xl">
      <form @submit.prevent="submit">
        <div class="p-8 -mr-6 -mb-8 flex flex-wrap">
          <MySelect :value="null" type="text" :error="errors.register_id" class="pr-6 pb-8 w-full lg:w-1/2" label="Register Id" :url="`/admin/registers`" @changeId="id=>form.register_id=id" />

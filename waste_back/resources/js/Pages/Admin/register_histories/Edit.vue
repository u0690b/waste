  ...
  <div>
    <h1 class="mb-8 font-bold text-3xl">
      <inertia-link
        ...
        :href="route('admin.register_histories.index')"
        >Register Histories</inertia-link
      >
      ...
      <form @submit.prevent="submit">
        <div class="p-8 -mr-6 -mb-8 flex flex-wrap">
          <MySelect
            ...
            label="Register Id"
            :url="`/admin/registers`"
            @changeId="(id) => (form.register_id = id)"
          />
          <number-input
            v-model="form.long"
            type="number"
        ...
        <div class="px-8 py-4 bg-gray-100 border-t border-gray-200 flex items-center">
          ...
          <loading-button
            ...
            type="submit"
            >Edit Register Histories</loading-button
          >
        </div>
      </form>
    </div>

      ...
      <div class="bg-white rounded shadow w-2/5">
        <form @submit.prevent="submit">
          <div class="p-8 -mr-6 -mb-8 flex-wrap">
            ...
            <MySelect :value="data.aimag_city" :error="errors.aimag_city_id" class="my-3" label="Аймаг/нийслэл нэр" :url="`/admin/aimag_cities`" @changeId="(id) => (form.aimag_city_id = id)" />
          </div>
          <div class="flex justify-center">
            <button :loading="form.processing" class="flex bg-gray-600 p-3 mx-3 text-white rounded text-base hover:bg-gray-500" type="submit">
              Засах
            </button>

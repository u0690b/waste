        ...
        <div class="p-4 mt-8 sm:px-8 sm:py-4">
            <div class="p-4 bg-white rounded shadow">
                ...
                <PaginationFilter v-model="form.model.per_page" v-model:search="form.model.search"
                    :total="datas.total" />
                <AdminTable :headers="headers" :datas="datas" url="/admin/soum_districts"
...
const title = 'Сум/дүүрэг жагсаалт'

const headers = [
    { key: 'code', name: 'Код', order: 'code' },
    { key: 'name', name: 'Аймаг нэр', order: 'name' },
    { key: 'short', name: 'товч', order: 'short' },

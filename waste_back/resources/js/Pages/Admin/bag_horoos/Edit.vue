<template>
  <div class="flex justify-between px-4 mt-4 sm:px-8">
    <h2 class="text-xl text-gray-600">
      <ILink class="text-gray-600 hover:text-gray-800  font-bold flex" :href="route('admin.bag_horoos.index')">
      ...
      <div class="bg-white rounded shadow w-2/5">
        <form @submit.prevent="submit">
          <div class="p-8 -mr-6 -mb-8 flex-wrap">
            ...
            <MySelect :value="data.soum_district" :error="errors.soum_district_id" class="py-3" label="Сум/дүүрэг нэр" :url="`/admin/soum_districts`" @changeId="(id) => (form.soum_district_id = id)" />
          </div>

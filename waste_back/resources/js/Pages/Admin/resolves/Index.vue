        ...
        <div class="p-4 mt-8 sm:px-8 sm:py-4">
            <div class="p-4 bg-white rounded shadow">
                ...
                <PaginationFilter v-model="form.model.per_page" v-model:search="form.model.search"
                    :total="datas.total" />
                <AdminTable :headers="headers" :datas="datas" url="/admin/resolves" @order-by="(v) => orderBy(form, v)">
                    <template #filter>
...
const title = 'Шийдвэрийн төрөл'

const headers = [
    { key: 'name', name: 'Шийдвэрийн төрөл', order: 'name', filter: false }
]

<template>
  <div class="flex justify-between px-4 mt-4 sm:px-8">
    <h2 class="text-xl text-gray-600">
      <ILink class="text-gray-600 hover:text-gray-600  font-bold flex" :href="route('admin.resolves.index')">
        ...
        <form @submit.prevent="submit">
          ...
          <div class="flex justify-center">
            ...
            <button :loading="form.processing" class="flex bg-gray-600  p-3 mx-4 my-3 text-white rounded text-base hover:bg-gray-500">
              <ILink class="text-white hover:text-white" :href="route('admin.resolves.index')">
                Буцах</ILink>
            </button>
          </div>
        </form>

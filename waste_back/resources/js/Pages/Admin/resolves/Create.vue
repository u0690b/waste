<template>
  <div class="flex justify-between px-4 mt-4 sm:px-8">
    <h2 class="text-xl text-gray-600">
      <inertia-link class="text-gray-600 hover:text-gray-600  font-bold flex" :href="route('admin.resolves.index')">
        ...
        Шийдвэрийн төрөл бүртгэл</inertia-link>
    </h2>
    <div class="flex items-center space-x-1 text-xs">
      ...
      <span class="text-gray-600 text-sm">Шийдвэрийн төрөл бүртгэл</span>
    </div>
  </div>
        ...
        <form @submit.prevent="submit">
          ...
          <div class="flex justify-center">
            ...
            <button :loading="form.processing"
              ...
              <inertia-link class="text-white hover:text-white" :href="route('admin.resolves.index')">
                Буцах</inertia-link>
            </button>
          </div>
        </form>

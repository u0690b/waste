<template>
  <div class="flex justify-between px-4 mt-4 sm:px-8">
    <h2 class="text-2xl text-gray-600 underline font-bold">Шалтгаан жагсаалт</h2>
    <div class="flex items-center space-x-1 text-xs">
      ...
      <span class="text-gray-600">Шалтгаан</span>
    </div>
  </div>
    ...
    <div class="p-4 bg-white rounded">
      <div class="mb-6 flex justify-between items-center">
        ...
        <inertia-link
          ...
          :href="route('admin.reasons.create')"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-6 w-6 mr-1"
  ...
  watch: {
    form: {
      handler: debounce(function () {
        this.$inertia.get(this.route("admin.reasons.index"), pickBy(this.form), {
          preserveState: true,
        });
      }, 150),
      deep: true,

...
const headers = [
  { key: 'code', name: 'Шалтгаан код', order: 'code' },
  { key: 'name', name: 'Шалтгаан', order: 'name' },
  { key: 'sub_group', name: 'Хог хаягдлын дэд бүлэг', order: 'sub_group' },
  { key: 'stype', name: 'Төрөл', order: 'stype' },
  { key: 'place.name', name: 'Хог хаягдлын бүлэг', order: 'place_id', url:'/admin/places' }
]

...
const parseLocation = (location) => {
    return {
        ...
        // label: location.status_id == 2 ? 'И' : location.status_id == 3 ? 'Ш' : '',
        icon: location.status_id == 2 ? blue : location.status_id == 3 ? yellow : null,
    }
}
...
const orange = 'http://maps.google.com/mapfiles/kml/paddle/orange-circle.png'
const yellow = 'http://maps.google.com/mapfiles/kml/paddle/ylw-circle.png'
const blue = 'http://maps.google.com/mapfiles/kml/paddle/red-circle.png'

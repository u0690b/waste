        ...
        <div class="p-4 mt-8 sm:px-8 sm:py-4">
            <div class="p-4 bg-white rounded shadow">
                ...
                <PaginationFilter v-model="form.model.per_page" v-model:search="form.model.search"
                    :total="datas.total" />
                <AdminTable :headers="headers" :datas="datas" url="/admin/legal_entities"
...
const title = 'Хуулийн этгээд жагсаалт'

const headers = [
    { key: 'register', name: 'Хуулийн этгээдийн регистр', order: 'register' },
    { key: 'name', name: 'Хуулийн этгээдийн нэр', order: 'name' },
    { key: 'industry', name: 'Үйл ажиллагааны чиглэл', order: 'industry' }
]

        ...
        <div class="mb-6 flex justify-between items-center">
          <div class="relative text-gray-400">
            ...
            <input id="search" name="search" type="search" v-model="form.search"
              ...
              placeholder="Үйл ажиллагааны чиглэл хайх" />
          </div>
        </div>
        <admin-table :headers="{ 'name': 'Үйл ажиллагааны чиглэл' }" :datas="datas" url="admin.industries.edit"
          :insertUrl="route('admin.industries.create')" deleteUrl="admin.industries.destroy" />

  ...
  <div class="flex justify-between px-4 mt-4 sm:px-8">
    <h2 class="text-xl text-gray-600">
      <inertia-link class="text-gray-600 hover:text-gray-800 font-bold flex" :href="route('admin.users.index')">
        ...
        </svg>Хэрэглэгчийн мэдээлэл засах</inertia-link>
    </h2>
    <div class="flex items-center space-x-1 text-xs">
      ...
      <span class="text-gray-600 text-sm">Хэрэглэгчийн мэдээлэл засах</span>
    </div>
  </div>
      ...
      <div class="bg-white rounded shadow w-2/5 pb-60">
        <form @submit.prevent="submit">
          <div class="p-8 -mr-6 -mb-8 flex-wrap">
            ...
            <CustomSelect v-model="form.position" selectClass="!py-3" required clearable valueKey="name"
              :options="positions" label="Албан тушаал" />

<template>
  <div class="flex justify-between px-4 mt-4 sm:px-8">
    <h2 class="text-xl text-gray-600">
      <ILink class="text-gray-600 hover:text-gray-800 font-bold flex" :href="route('admin.statuses.index')">
      ...
      <div class="bg-white rounded shadow w-2/5">
        <form @submit.prevent="submit">
          ...
          <div class="flex justify-center">
            ...
            <button :loading="form.processing" class="flex bg-gray-600 p-3 mx-4 my-3 text-white rounded text-base hover:bg-gray-500" @click="goBack">
              Буцах
            </button>
          </div>
        </form>

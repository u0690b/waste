    ...
    <div class="bg-white rounded shadow overflow-hidden max-w-3xl p-6">
      <h1 class="mb-8 font-bold text-3xl">
        <inertia-link class="text-indigo-400 hover:text-indigo-600"
          :href="route('admin.registers.index')">Registers</inertia-link>
        <span class="text-indigo-400 font-medium">/</span> Create
      </h1>
      <form @submit.prevent="submit">
        <div class="grid grid-cols-2 gap-2 ">
          <MyInput v-model="form.name" type="text" :error="errors.name" class=""
          ...
          <MySelect :value="null" type="text" :error="errors.aimag_city_id" class="" label="Аймаг,Нийслэл"
            :url="`/admin/aimag_cities`" @changeId="id => form.aimag_city_id = id" />
          <MySelect :value="null" type="text" :error="errors.soum_district_id" class="" label="Сум,Дүүрэг"
            :url="`/admin/soum_districts`" @changeId="id => form.soum_district_id = id" />
          <MySelect :value="null" type="text" :error="errors.bag_horoo_id" class="" label="Баг,Хороо"
          ...
          <MyInput v-model="form.resolve_desc" type="text" :error="errors.resolve_desc" class=""
          ...
          <MySelect :value="null" type="text" :error="errors.reg_user_id" class="" label="Бүртгэсэн Хүн"
            :url="`/admin/users`" @changeId="id => form.reg_user_id = id" />
          <MySelect :value="null" type="text" :error="errors.comf_user_id" class="" label="Шийдвэрлэсэн Хүн"
            :url="`/admin/comf_users`" @changeId="id => form.comf_user_id = id" />
          <MySelect :value="null" type="text" :error="errors.status_id" class="" label="Төлөв" :url="`/admin/statuses`"

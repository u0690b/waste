    ...
    <div class="bg-white rounded shadow overflow-hidden max-w-3xl p-6">
      ...
      <form @submit.prevent="submit">
        <div class="grid grid-cols-2 gap-2">
          ...
          <MySelect :value="data.aimag_city" type="text" :error="errors.aimag_city_id" class="" label="Аймаг,Нийслэл"
            :url="`/admin/aimag_cities`" @changeId="(id) => (form.aimag_city_id = id)" />
          <MySelect :value="data.soum_district" type="text" :error="errors.soum_district_id" class="" label="Сум,Дүүрэг"
            :url="`/admin/soum_districts`" @changeId="(id) => (form.soum_district_id = id)" />
          <MySelect :value="data.bag_horoo" type="text" :error="errors.bag_horoo_id" class="" label="Баг,Хороо"
          ...
          <MySelect :value="data.reason" type="text" :error="errors.reason_id" class="" label="Зөрчилийн Төрөл"
          ...
          <MySelect :value="data.status" :error="errors.status_id" class="" label="Төлөв" :url="`/admin/statuses`"

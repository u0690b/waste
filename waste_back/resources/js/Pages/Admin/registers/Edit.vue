     ...
     <h1 class="mb-8 font-bold text-3xl">
      ...
      <form @submit.prevent="submit">
        <div class="grid grid-cols-2 gap-2 ">
          ...
          <MyInput v-model="form.description" type="text" :error="errors.description" class="" label="Гаргасан Зөрчилийн Байдал" />
          <MySelect :value="data.reason" type="text" :error="errors.reason_id" class="" label="Зөрчилийн Төрөл" :url="`/admin/reasons`" @changeId="id=>form.reason_id=id" />
          ...
          <MySelect :value="data.reg_user" type="text" :error="errors.reg_user_id" class="" label="Бүртгэсэн Хүн" :url="`/admin/reg_users`" @changeId="id=>form.reg_user_id=id" />
          <MySelect :value="data.comf_user" type="text" :error="errors.comf_user_id" class="" label="Шийдвэрлэсэн Хүн" :url="`/admin/comf_users`" @changeId="id=>form.comf_user_id=id" />
          <MySelect :value="data.status" type="text" :error="errors.status_id" class="" label="Төлөв" :url="`/admin/statuses`" @changeId="id=>form.status_id=id" />
        </div>

        ...
        <form @submit.prevent="submit">
          <div class="grid grid-cols-4 gap-4">
            <div>
              ...
              <MySelect :value="data.comf_user" :error="errors.comf_user_id" class="text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" :url="`/admin/users?soum_district_id=${data.soum_district_id}`" @changeId="(id) => (form.comf_user_id = id)" />
            </div>

            <div class="py-1">
              <button :loading="form.processing" class="mx-4 bg-gray-600 p-2 my-5 text-white rounded text-base hover:bg-gray-500" type="submit">
                Хадгалах
              </button>
              <button :loading="form.processing" class=" bg-gray-600 p-2 my-5 text-white rounded text-base hover:bg-gray-500">

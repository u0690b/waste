            ...
            <div class="px-4 py-2 bg-white border rounded-md shadow">
                ...
                <div class="grid grid-cols-2">
                    <form @submit.prevent="submit">
                        <MySelect :value="data.resolve_id" :error="errors.resolve_id" class=" text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-80 p-3 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" label="Шийдвэрийн төрөл" :url="`/admin/resolves`" @changeId="(id) => (form.resolve_id = id)" />
                        <div class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                            <div class="flex items-center justify-between px-3 py-2 border-b dark:border-gray-600">
                                <div class="flex flex-wrap items-center divide-gray-200 sm:divide-x dark:divide-gray-600">
                                    <div class="flex items-center space-x-1 sm:pr-4">
                                        <FileInput v-model="form.image" :error="errors.image" class="" accept="image/*" label="Зураг">
                            ...
                            <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                                ...
                                <textarea id="editor" rows="4" v-model="form.resolve_desc" :error="errors.resolve_desc" class="block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write an article..." required></textarea>
                            </div>
                        </div>
                        ...
                        <div class="flex">
                            <button :loading="form.processing" class="flex bg-gray-600 p-2 my-3 text-white rounded text-base hover:bg-gray-500" type="submit">
                                Хадгалах
                            </button>
                            <button :loading="form.processing" class="flex bg-gray-600  p-2 mx-4 my-3 text-white rounded text-base hover:bg-gray-500">

    ...
    <div>
      <div class="flex justify-between px-4 mt-4 sm:px-8">
        <h2 class="text-xl text-gray-600">
          <inertia-link class="flex font-bold text-black hover:text-gray-800" :href="route('dashboard')">
      ...
      <div class="grid grid-cols-1 gap-4 px-4 mt-8 sm:grid-cols-3 sm:px-8">
        <div class="px-4 py-2 bg-white border rounded-md shadow">
          <h3 class="mb-4 text-xl text-gray-600">Нийт зөрчил төлөв</h3>
          <VueApexCharts class="p-4 bg-white" type="pie" :options="statDonut.chartOptions" :series="statDonut.series">
          </VueApexCharts>
        </div>
        <div class="col-span-2 px-4 py-2 bg-white border rounded-md shadow">
          <h3 class="mb-4 text-xl text-gray-600">Зөрчлийн төрлөөр</h3>
      ...
      <div class="grid grid-cols-1 gap-4 px-4 mt-8 sm:grid-cols-3 sm:px-8">
        ...
        <div class="col-span-2 px-4 py-2 bg-white border rounded-md shadow">
          <h3 class="mb-4 text-xl text-gray-600">Харьяалагдах нутаг дэвсгэрээр</h3>
          <VueApexCharts class="p-4 mb-8 bg-white" type="bar" height="350" :options="regionOptions.chartOptions" :series="regionOptions.series">
          </VueApexCharts>
        </div>
        <div class="px-4 py-2 bg-white border rounded-md shadow">
          <h3 class="mb-4 text-xl text-gray-600">Зөрчил хуваарилалтаар</h3>
      ...
      <div class="grid grid-cols-2">
        <div class="px-4 py-2 mx-4 mt-8 bg-white border rounded-md shadow sm:mx-8">
          <h3 class="mb-4 text-xl text-gray-600">Олон зөрчил гаргасан аж ахуйн нэгжүүд</h3>
          <VueApexCharts class="p-4 mb-8 bg-white" type="bar" height="350" :options="etgeedOptions.chartOptions" :series="etgeedOptions.series">
          </VueApexCharts>
        </div>
        <div class="px-4 py-2 mx-4 mt-8 bg-white border rounded-md shadow sm:mx-8">
          <h3 class="mb-4 text-xl text-gray-600">Олон зөрчил гаргасан иргэд</h3>

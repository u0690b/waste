...
<template>
    ...
    <Admin>
        <div class="container ml-8">
                ...
                <div class="grid gap-4 lg:grid-cols-2">
                    <div class="flex items-center max-sm:text-xs">
                        <div class="p-4 px-4  md:p-8 text-[#406f47]  sm:px-8 text-center" id="about" role="tabpanel"
                            ...
                            <div class="mt-10">
                                <a class=" sm:text-xl  py-2 px-4 bg-[#dde9aa]  hover:border Text-[#406f47] rounded-full "
                                    type="button" target="_blank" href="/mobile">
                                    Бидэнтэй нэгдэх
                                </a>
                            </div>
                        </div>
            ...
            <section>
                <div
                    className="border-[#406f47] border-4 hover:shadow-lg inset-2 shadow-[#31A95D22]  rounded-lg flex flex-col gap-6 animate-in fade-in-0 duration-500">

                    <div class="grid gap-6 ">
                        <div class="col-span-2 px-4 py-2 overflow-hidden bg-white border rounded-md shadow">
                            <h3 class="flex mb-4 text-xl text-gray-600"><svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            <VueApexCharts class="p-4 mb-8 bg-white" type="bar" height="350"
                                :options="regionOptions.chartOptions" :series="regionOptions.series">
                            </VueApexCharts>
                        </div>

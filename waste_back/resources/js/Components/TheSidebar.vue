<template>
  <aside class="hidden w-64 bg-gray-800 sm:block">
    ...
    >
      <inertia-link to="/" class="text-white">Tailmin</inertia-link>
    </div>
    ...
    <nav class="text-sm text-gray-300">
      <ul class="flex flex-col">
        ...
        <li class="px-4 cursor-pointer hover:bg-gray-700">
          <inertia-link :href="{ name: 'card' }" class="py-2 flex items-center">
            <svg
              class="h-5 w-5 mr-2"
              viewBox="0 0 20 20"
              fill="none"
        ...
        <li class="px-4 cursor-pointer hover:bg-gray-700">
          <inertia-link :href="{ name: 'login' }" class="py-2 flex items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-5 w-5 mr-2"
              fill="none"

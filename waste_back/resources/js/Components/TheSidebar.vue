<template>
  <aside class="hidden w-64 bg-gray-800 sm:block">
    <div class="py-3 text-2xl uppercase text-center tracking-widest bg-gray-900 border-b-2 border-gray-800 mb-8">
      <ILink to="/" class="text-white">Tailmin</ILink>
    </div>
      ...
      <ul class="flex flex-col">
        ...
        <li>
          <Disclosure v-slot="{ open }">
            <DisclosureButton class="px-4 py-3 flex items-center w-full hover:bg-gray-700" :class="open ? 'bg-gray-700' : ''">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
              </svg>
              User Management
              <span class="ml-auto">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" :class="open ? 'transform rotate-90' : ''">
            ...
            <DisclosurePanel>
              <ul>
                <li>
                  <Disclosure v-slot="{ open }">
                    <DisclosureButton class="pl-8 pr-4 py-3 flex items-center w-full hover:bg-gray-700" :class="open ? 'bg-gray-700' : ''">
                    ...
                    <DisclosurePanel>
                      <ul>
                        <ILink to="/users" custom>
                          <li class="pl-12" :class="[
                            isExactActive
        ...
        <li class="px-4 py-2 mt-2 text-xs uppercase tracking-wider text-gray-500 font-bold">
          Apps
        </li>
        ...
        <li class="px-4 cursor-pointer hover:bg-gray-700">
          <ILink :href="{ name: 'card' }" class="py-2 flex items-center">
        ...
        <li class="px-4 cursor-pointer hover:bg-gray-700">
          <ILink :href="{ name: 'login' }" class="py-2 flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">

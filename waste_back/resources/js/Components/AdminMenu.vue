...
<template>
    ...
    <aside class="hidden min-w-64 bg-[#406f47] sm:block">
        ...
        <nav class="text-sm text-gray-300">
            <ul class="flex flex-col">
                <li class="px-4 py-2 text-xs font-bold tracking-wider uppercase">
                    Үндсэн цэс
                </li>
                <SidebarItem v-for="menu in menus" :key="menu.text" :menu="menu"
                    class="px-4 py-2 text-xs font-bold tracking-wider text-white uppercase" />
                <li class="px-4 py-2 text-xs font-bold tracking-wider uppercase">
                    Тохиргоо
                </li>

...
class Waste {
  ...
  Waste.fromJson(Map<String, dynamic> snap) {
    ...
    soumDistrictId =
        snap['soum_district_id'] == null ? null : snap['soum_district_id'];
    bagHorooId = snap['soum_district_id'] == null ? null : snap['bag_horoo_id'];
